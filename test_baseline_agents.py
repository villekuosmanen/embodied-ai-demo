...
CFG_TEST = "config/test/habitat/habitat_all_sensors_test.yaml"
...
def test_ppo_agents(input_type, resolution):
    ...
    with habitat.config.read_write(ppo_agent_config):
        config_env = habitat.get_config(config_path=CFG_TEST, configs_dir="config")
